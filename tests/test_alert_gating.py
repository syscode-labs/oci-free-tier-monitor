...
class ScheduledAlertGatingTests(unittest.TestCase):
    ...
    def test_repeated_non_threshold_findings_only_alert_when_changed(self):
        # Test that custom images detection works correctly
    ...
    def test_threshold_breach_alerts_only_once_when_amount_unchanged(self):
        ...
        # When the same spend amount is checked twice, alert should not repeat
        with self.patch_common_checks():
    ...
    def test_ampere_compute_above_new_free_tier_limits_alerts(self):
        ...
        with self.patch_common_checks():
            # Set up state max_ampere_instances to 2 so 3 instances triggers a breach
            self.monitor._state["max_ampere_instances"] = 2
            ...
            # Verify the breaches were generated by checking threshold_alerts
